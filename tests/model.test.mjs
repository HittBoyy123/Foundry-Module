...
test("legacy enable and override fields are ignored", () => {
  ...
  assert.deepEqual(result.flags, { schemaVersion: 2, material: "stone", tier: 2 });
});
...
test("all supplied materials support armor and apply only the AC effect", () => {
  for (const material of Object.keys(config.materials)) {
