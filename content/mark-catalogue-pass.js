...
add("carpentry", "specialty-3", {
  ...
  "bear-carving": m("While this shield is raised, gain +2 Artisan Bonus to AC for a tower or fortress shield, +1 for other non-buckler shields, or no extra AC for a buckler. This adds to normal raised-shield AC and does not grant cover. While raised, gain physical resistance equal to 3 × Core Tier; against damage caused by forced movement, use 6 × Core Tier instead. Use only the applicable resistance value, not both.", ["shield"]),
